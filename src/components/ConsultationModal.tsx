...
export const ConsultationModal: React.FC<ConsultationModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-300">
      <div className="bg-white rounded-[24px] max-w-xl w-full p-6 sm:p-8 relative shadow-2xl border border-zinc-200 my-8">
        ...
        {submitted ? (
          <div className="text-center py-12 space-y-4">
            ...
            <h3 className="text-2xl font-extrabold text-zinc-900">Briefing Request Received</h3>
            <p className="text-sm text-zinc-600 max-w-md mx-auto">
              Thank you, <span className="font-semibold text-zinc-900">{formData.name}</span>. CEO Vivek Gupta’s senior strategist will contact you confidentially on <span className="font-semibold text-zinc-900">{formData.phone}</span> within 2 hours.
            </p>
            <div className="pt-4 text-xs font-semibold text-[#ff7a00]">
          ...
          <div className="space-y-6">
            ...
            {/* Modal Header */}
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-100 text-[#ff7a00] text-xs font-bold uppercase tracking-wider mb-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-left">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-3.5 py-2.5 text-sm text-zinc-900 focus:outline-none focus:border-[#ff7a00] focus:bg-white transition-colors"
                  />
                </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#ff7a00] hover:bg-black text-white font-extrabold py-3.5 rounded-xl uppercase tracking-wider text-sm transition-all duration-300 shadow-lg shadow-orange-500/20 flex items-center justify-center gap-2"
              >
