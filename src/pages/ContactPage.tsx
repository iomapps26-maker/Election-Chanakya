...
export const ContactPage: React.FC<ContactPageProps> = () => {
  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-white text-zinc-950 overflow-hidden pt-24 pb-16 border-b border-zinc-200">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-zinc-950 leading-tight">
            Schedule a Confidential <span className="text-gradient-dark">Briefing</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white p-5 rounded-2xl flex items-start gap-4 border border-zinc-200 shadow-sm">
                <div className="w-10 h-10 rounded-xl bg-zinc-100 text-black border border-zinc-300 flex items-center justify-center shrink-0">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-zinc-950">Headquarters Address</h3>
                  <p className="text-sm text-zinc-700 mt-1 leading-relaxed font-medium">
              ...
              <div className="bg-white p-5 rounded-2xl flex items-start gap-4 border border-zinc-200 shadow-sm">
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-950">Confidential Phone Hotline</h3>
                  <a href={`tel:${COMPANY_INFO.phone}`} className="text-base font-extrabold text-black block mt-1 hover:underline">
                    {COMPANY_INFO.phone}
                  </a>
                  <p className="text-xs text-zinc-500 font-medium mt-0.5">Available 24/7 during campaign periods</p>
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl flex items-start gap-4 border border-zinc-200 shadow-sm">
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-950">Official Email</h3>
                  <a href={`mailto:${COMPANY_INFO.email}`} className="text-sm font-semibold text-zinc-700 hover:text-black">
                    {COMPANY_INFO.email}
                  </a>
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl flex items-start gap-4 border border-zinc-200 shadow-sm">
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-950">Leadership Contact</h3>
                  <p className="text-sm text-black font-extrabold mt-1">
                    CEO: {COMPANY_INFO.ceo}
                  </p>
                  <p className="text-xs text-zinc-500 font-medium mt-0.5">Private briefings arranged under binding NDA.</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 rounded-[24px] border border-zinc-200 shadow-xl space-y-6">
              ...
              {submitted ? (
                <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 text-center space-y-3">
                  ...
                  <h4 className="text-lg font-bold text-zinc-950">Inquiry Received</h4>
                  <p className="text-xs text-zinc-700">
                    Thank you. CEO Vivek Gupta’s office will contact you on <span className="font-bold text-black">{formState.phone}</span> shortly.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-zinc-50 border border-zinc-300 rounded-xl px-4 py-3 text-xs text-zinc-950 focus:outline-none focus:border-black transition-colors"
                      />
                    </div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-black hover:bg-zinc-800 text-white font-black py-3.5 rounded-xl uppercase tracking-wider text-xs transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
                  >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-[24px] overflow-hidden border border-zinc-200 shadow-xl space-y-2">
          <div className="bg-zinc-900 p-4 text-white flex items-center justify-between">
            ...
            <span className="text-xs text-zinc-300 font-semibold">{COMPANY_INFO.phone}</span>
          </div>
