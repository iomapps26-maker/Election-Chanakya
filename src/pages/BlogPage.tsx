    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {filteredPosts.map((post) => (
            <div
              key={post.id}
              className="white-glass-card rounded-[22px] overflow-hidden group flex flex-col justify-between border border-zinc-200 hover:border-[#ff7a00] transition-all"
            >
              <div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <h3 className="text-lg font-extrabold text-zinc-900 group-hover:text-[#ff7a00] transition-colors leading-snug">
                    {post.title}
                  </h3>
              ...
              <div className="p-6 pt-2 border-t border-zinc-100">
                <button
                  ...
                  className="w-full bg-zinc-900 hover:bg-[#ff7a00] text-white py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5"
                >
      ...
      {activePost && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-300">
          <div className="bg-white rounded-[24px] max-w-3xl w-full p-6 sm:p-10 relative shadow-2xl border border-zinc-200 my-8 space-y-6">
            ...
            <div className="space-y-3">
              <span className="text-xs font-bold uppercase tracking-wider text-[#ff7a00] bg-orange-50 px-3 py-1 rounded-full border border-orange-100">
                {activePost.category}
              </span>
              ...
              <div className="flex items-center gap-4 text-xs text-zinc-500 pt-1 border-b border-zinc-100 pb-3">
            ...
            <div className="text-sm text-zinc-700 space-y-4 leading-relaxed font-normal whitespace-pre-line">
              {activePost.content}
            </div>
            ...
            <div className="pt-6 border-t border-zinc-100 flex items-center justify-between">
              ...
              <button
                ...
                className="bg-[#ff7a00] text-white px-5 py-2.5 rounded-xl text-xs font-bold uppercase hover:bg-black transition-colors"
              >
                Discuss Strategy
              </button>
            </div>
