...
export const AboutPage: React.FC<AboutPageProps> = ({
  ...
  return (
    <div className="space-y-20 pb-16">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-white text-zinc-950 overflow-hidden pt-24 pb-16 border-b border-zinc-200">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-10 scale-105 transition-transform duration-[10000ms]"
          style={{
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-zinc-950 leading-tight">
            Pioneering Empirical Psephology & <span className="text-gradient-orange">Electoral Engineering</span>
          </h1>

          <p className="text-base sm:text-xl text-zinc-700 font-medium max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            ...
            <a
              ...
              className="border border-zinc-300 hover:border-orange-500 text-zinc-900 px-8 py-3.5 rounded-full text-xs font-bold uppercase tracking-wider transition-colors bg-white shadow-sm"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-zinc-950 tracking-tight leading-snug">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="p-4 bg-zinc-100 rounded-2xl border border-zinc-300">
                <p className="text-2xl font-extrabold text-black">22 Million+</p>
                <p className="text-xs font-semibold text-zinc-600 mt-1">Field Respondents Polled</p>
              </div>
              <div className="p-4 bg-white text-zinc-900 rounded-2xl border border-zinc-300 shadow-sm">
                <p className="text-2xl font-extrabold text-black">95.4%</p>
                <p className="text-xs font-semibold text-zinc-600 mt-1">Predictive Accuracy Rate</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl overflow-hidden shadow-md border border-zinc-200 mt-8">
              <img
      ...
      <section className="bg-zinc-100/80 text-zinc-900 py-16 border-y border-zinc-200 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            
            {/* CEO Portrait Card */}
            <div className="lg:col-span-1 space-y-4">
              <div className="rounded-[24px] overflow-hidden border-2 border-black shadow-xl relative group">
                <img
                  src={ceo.image}
                  alt={ceo.name}
                ...
                <div className="absolute bottom-4 left-4 right-4 text-center bg-white p-3 rounded-xl border border-zinc-300 shadow-md">
                  <p className="text-lg font-extrabold text-black">{ceo.name}</p>
                  <p className="text-xs text-zinc-600 font-bold">{ceo.role}</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <span className="px-3 py-1 rounded-full bg-zinc-200 text-zinc-900 border border-zinc-300 text-xs font-bold uppercase tracking-wider">
                Message from Leadership
              </span>

              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-zinc-950 leading-snug">
                "Modern Elections Are Won on Polling Booth Tables, Not in Television Studios."
              </h2>

              <p className="text-sm sm:text-base text-zinc-800 leading-relaxed italic font-medium">
              ...
              <div className="pt-2 flex items-center gap-4 border-t border-zinc-300">
                <div>
                  <p className="text-base font-extrabold text-black">{COMPANY_INFO.ceo}</p>
                  <p className="text-xs text-zinc-600 font-bold">Chief Executive Officer, Election Chanakya</p>
                </div>
                <button
                  onClick={onOpenConsultationModal}
                  className="ml-auto bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white px-5 py-2.5 rounded-full text-xs font-bold uppercase transition-all shadow-md shadow-orange-600/20"
                >
                  Direct Briefing
                </button>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-[24px] space-y-4 border-t-4 border-t-black border-x border-b border-zinc-200 shadow-md">
            <div className="w-12 h-12 rounded-2xl bg-zinc-100 text-black border border-zinc-300 flex items-center justify-center font-bold">
              <Target className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-extrabold text-zinc-950">Our Mission</h3>
            <p className="text-sm text-zinc-600 leading-relaxed font-normal">
          ...
          <div className="bg-white p-8 rounded-[24px] space-y-4 border-t-4 border-t-zinc-800 border-x border-b border-zinc-200 shadow-md">
            <div className="w-12 h-12 rounded-2xl bg-zinc-100 text-black border border-zinc-300 flex items-center justify-center font-bold">
              <Compass className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-extrabold text-zinc-950">Our Vision</h3>
            <p className="text-sm text-zinc-600 leading-relaxed font-normal">
          ...
          <div className="bg-white p-8 rounded-[24px] space-y-4 border-t-4 border-t-black border-x border-b border-zinc-200 shadow-md">
            ...
            <h3 className="text-xl font-extrabold text-zinc-950">Core Values</h3>
            <p className="text-sm text-zinc-600 leading-relaxed font-normal">
      ...
      <section className="bg-zinc-100/80 py-16 border-y border-zinc-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-3xl font-extrabold text-zinc-950">A Decade of Electoral Excellence</h2>
          </div>
          ...
          <div className="space-y-6 relative before:absolute before:inset-0 before:left-4 sm:before:left-1/2 before:w-0.5 before:bg-zinc-300">
            {[
              ...
              <div key={idx} className="relative flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="w-full sm:w-[45%] bg-white p-5 rounded-2xl border border-zinc-200 shadow-sm">
                  <span className="text-xs font-extrabold text-black font-mono">{m.year}</span>
                  <h3 className="text-base font-bold text-zinc-950 mt-1">{m.title}</h3>
                  <p className="text-xs text-zinc-600 mt-1 leading-relaxed">{m.desc}</p>
                </div>
                <div className="w-8 h-8 rounded-full bg-black text-white font-bold text-xs flex items-center justify-center shrink-0 z-10 shadow-md">
                  ✓
                </div>
